...
export default function VistaInicioSesion({ onLogin }: Props) {
  ...
  return <main className="login-page">
    ...
    <form className="login-card" onSubmit={ingresar}>
      <div className="login-brand"><img src="/logo-hospital-original.png" alt="Logo Hospital Maria Esperanza" /></div>
      ...
      <div className="login-opciones"><label><input type="checkbox" checked={recordar} onChange={(e) => { const activo = e.target.checked; setRecordar(activo); if (!activo) localStorage.removeItem('pulso_usuario_recordado'); }} /> Mantener sesión en este equipo</label><span>Solo personal autorizado</span></div>
